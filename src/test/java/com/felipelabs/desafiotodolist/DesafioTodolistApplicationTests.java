...
import static com.felipelabs.desafiotodolist.TestContains.TODO;
import static com.felipelabs.desafiotodolist.TestContains.TODOS;
...
class DesafioTodolistApplicationTests {
	...
	public void testDeleteTodoSuccess() {
		webTestClient
				...
				.jsonPath("$[0].concluido").isEqualTo(TODOS.get(1).isConcluido())
